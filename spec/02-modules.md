...
| `Services/FailureLoopEvidencePreviewFormatter.cs` | `FailureLoopEvidencePreviewFormatter` | 将证据包格式化为紧凑可复制文本，包含命令、transcript、daemon log 与 Agent planned/empty 提示；纯 Core、不读写磁盘 |
