...
{
    private static string RootDir => Path.Combine(CompatibilityOptions.GetAgentDir());
    private static string ThreadsDir => Path.Combine(RootDir, "threads");
    private static string ThreadsIndexPath => Path.Combine(RootDir, "threads.json");
